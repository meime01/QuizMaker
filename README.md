QuizMaker is a real-time, interactive quiz platform built with React, Firebase, and Firestore. It allows users to create, join, and compete in quizzes with live leaderboards, timers, and instant feedback.
